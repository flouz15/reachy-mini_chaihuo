...
def test_accepts_short_poem_style_journal() -> None:
    body = "如果要走，请你远走。去丈量宽广的土地，去见识广阔的山河。" * 4
    result = JournalFetcher.extract_yuque_document(
        yuque_page("poem123", "基地车日记｜2026.8.22-8.23 如果要走", body),
        "https://www.yuque.com/mouseart/mcv/poem123",
    )
    assert result["dates"] == ["2026-08-22", "2026-08-23"]
    assert "如果要走" in result["content"]
